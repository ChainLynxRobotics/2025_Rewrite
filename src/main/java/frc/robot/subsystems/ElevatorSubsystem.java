...
import static frc.robot.Constants.ElevatorConfig.kP;
...
public class ElevatorSubsystem extends SubsystemBase {
  ...
  private SysIdRoutine sysIdRoutine =
      new SysIdRoutine(
          new SysIdRoutine.Config(Volts.of(0.5).per(Seconds), Volts.of(4.5), Seconds.of(6)),
  ...
  public void periodic() {
    talonFXConfiguration.Slot0 = slot0Configs.withKP(SmartDashboard.getNumber("kP", 0.0));
  }
